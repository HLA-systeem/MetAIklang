...
module.exports.run = async (bot,message,args) => {
    let helpMessage = new DISCORD.RichEmbed()
        ...
        .addField(PREFIX + "Purify <amount>", " Deletes images and messages of this bot. If no number is given, it will purify all images in the channel until around 50 messages past. Otherwise it will grab that amount of the last messages")
        ...
        .addField(PREFIX + "Stop", "Leaves the voice chat")
        .addField(PREFIX + "Mute", "Mute/Unmute MetAIklang")
